...
async def send_message(task: Dict, config: ConfigParser):
...
async def handle_tasks(tasks: List, config: ConfigParser):
    for task in tasks:
        await send_message(task, config)
...
async def main(bot: Bot, config: ConfigParser):
    ...
    for query in search_queries:
        ...
        await handle_tasks(tasks, config)
...
if __name__ == "__main__":
    ...
    bot = Bot(config_parser['BOT']['TOKEN'])
